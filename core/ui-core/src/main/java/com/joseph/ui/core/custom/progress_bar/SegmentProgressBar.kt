...
class SegmentedProgressBar : View, Runnable, ViewPager.OnPageChangeListener, View.OnTouchListener {
    ...
    var segmentBackgroundColor: Int = Color.GRAY
        private set
    var segmentSelectedBackgroundColor: Int = Color.WHITE
        private set

    var segmentStrokeColor: Int = Color.TRANSPARENT
        private set

    var segmentSelectedStrokeColor: Int = Color.TRANSPARENT
        private set
    ...
    var viewPager: ViewPager2? = null
        ...
        set(value) {
            ...
            if (value == null) {
                ...
                viewPager?.getChildAt(0)?.setOnTouchListener(onTouchListener)
            }
        }
