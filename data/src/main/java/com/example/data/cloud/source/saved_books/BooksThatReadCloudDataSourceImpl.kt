            ...
            booksThatReadCloud.body()!!.books.forEach { booksThatRead ->
                ...
                if (bookCloudList.isNotEmpty()) {
                    ...
                    val book = BookMapper.Base(
                        author = bookCloud.author ?: String(),
                        id = bookCloud.id ?: String(),
                        poster = bookCloud.poster ?: BookPosterCloud.unknown,
                        page = bookCloud.page ?: 0,
                        chapterCount = bookCloud.chapterCount ?: 0,
                        publicYear = bookCloud.publicYear ?: String(),
                        title = bookCloud.title ?: String(),
                        updatedAt = bookCloud.updatedAt ?: Date()
                    )
