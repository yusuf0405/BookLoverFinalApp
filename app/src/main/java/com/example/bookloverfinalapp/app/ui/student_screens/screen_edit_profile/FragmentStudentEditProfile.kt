...
import com.example.bookloverfinalapp.app.utils.RESULT_LOAD_IMAGE
import com.example.bookloverfinalapp.databinding.FragmentStudentEditProfileBinding
...
@AndroidEntryPoint
class FragmentStudentEditProfile :
    BaseFragment<FragmentStudentEditProfileBinding, FragmentStudentEditProfileViewModel>(
        FragmentStudentEditProfileBinding::inflate), View.OnClickListener {

    override val viewModel: FragmentStudentEditProfileViewModel by viewModels()
    ...
    private fun setOnClickListeners() {
        binding().apply {
            saveEditButton.setOnClickListener(this@FragmentStudentEditProfile)
            editStudentImage.setOnClickListener(this@FragmentStudentEditProfile)
            confirmPasswordBtn.setOnClickListener(this@FragmentStudentEditProfile)
            female.setOnClickListener(this@FragmentStudentEditProfile)
            male.setOnClickListener(this@FragmentStudentEditProfile)
    ...
    private fun updateStudent() {
        binding().apply {
            ...
            viewModel.updateStudent(id = this@FragmentStudentEditProfile.student.id,
